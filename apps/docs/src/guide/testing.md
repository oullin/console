...
```ts
import { Key, createMemoryOutput, createScriptedInput, text, withPromptEnvironment } from '@ollin/console';
...
```ts
import { Key, confirm, createMemoryOutput, createScriptedInput, select, text, withPromptEnvironment } from '@ollin/console';

...
`@ollin/console` uses `PromptEnvironment` as the boundary for input, output, and interactivity.
...
```ts
import { createMemoryOutput, createScriptedInput, select, text, withPromptEnvironment } from '@ollin/console';

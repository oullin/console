...
```ts
import { alert, error, info, intro, note, outro, warning } from '@ollin/console';
...
```ts
import { alert, error, form, info, intro, note, outro, warning } from '@ollin/console';
...
```ts
import { info, intro, outro, warning } from '@ollin/console';

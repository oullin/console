...
```ts
import { dataTable, table } from '@ollin/tui';
...
```ts
import { datatable } from '@ollin/tui';
...
```ts
import { dataTable, datatable, form, grid, table } from '@ollin/tui';

table({
	headers: ['Package', 'Purpose'],
	rows: [
		{ Package: '@ollin/tui', Purpose: 'Runtime prompts' },
...
<TerminalOutput :lines='["Package     Purpose","@ollin/tui  Prompts","docs        Documentation"]' />

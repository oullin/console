...
```ts
import { clearTerminal } from '@ollin/tui';
...
```ts
import { clear, clearTerminal, eraseLine, erasePreviousLines, form } from '@ollin/tui';
...
```ts
import { clear, info } from '@ollin/tui';

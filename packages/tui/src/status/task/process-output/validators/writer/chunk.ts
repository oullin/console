import { z } from 'zod';
import { parseProcessOutputCallback, parseProcessOutputEncoding } from '#tui/status/task/process-output/validators/writer/callback';
import type { ProcessOutputCallback } from '#tui/status/task/process-output/validators/writer/callback';

...
import { availableDataTableCellWidth } from '#tui/output/data-table/widths/available';
import { naturalDataTableColumnWidth } from '#tui/output/data-table/widths/natural';
import { shrinkDataTableColumnWidths } from '#tui/output/data-table/widths/shrink';

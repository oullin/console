...
export const markedDisplayedMultiSearchChoiceIndexes = <T>(
...
export const moveDisplayedMultiSearchHighlight = async <T>(
	query: MultiSearchChoiceQuery<T>,
...
export const toggleAllDisplayedMultiSearchSelection = <T>(
	query: MultiSearchChoiceQuery<T>,
	selected: SearchSelection<T>,
): void => {
...
export const toggleHighlightedDisplayedMultiSearchSelection = <T>(
	query: MultiSearchChoiceQuery<T>,
	selected: SearchSelection<T>,
	highlighted: MultiSearchHighlightState<T>,
): void => {

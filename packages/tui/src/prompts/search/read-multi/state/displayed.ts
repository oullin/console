...
import { markedMultiSearchChoiceIndexes, toggleAllDisplayedMultiSearchChoices, toggleHighlightedMultiSearchChoice } from '#tui/prompts/search/read-multi/state/selection';

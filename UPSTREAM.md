...
| Multi-search active boxed layout and selected-count footer | `packages/tui/src/prompts/search/render.ts`, `packages/tui/src/prompts/search/render-body.ts`, `packages/tui/src/prompts/search/body/*`, `packages/tui/tests/search.test.ts` |
